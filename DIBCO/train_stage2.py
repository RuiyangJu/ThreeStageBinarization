...
#from method1_NA_LL import Dataset_Return_Four
from method2_NA_LLandNorm import Dataset_Return_Four
#from method3_LL_LL import Dataset_Return_Four
#from method4_LLandNorm_LLandNorm import Dataset_Return_Four
...
def unetplusplus_train(epochs, gpu, base_model_name, encoder_weights, generator_lr, discriminator_lr, lambda_bce, threshold,
                batch_size, image_train_dir, mask_train_dir, image_test_dir, mask_test_dir):
    # make save directory
    weight_path = './UnetPlusPlus/stage2_dibco_' + base_model_name + '_' + str(int(lambda_bce)) + '_' + str(generator_lr) + '_' + str(threshold) 
...
if __name__ == "__main__":
    ...
    # data set
    parser.add_argument('--image_train_dir', type=str, default='../ThreeStageBinarization/data/denoise/deep_standard/train/image_patches/', help='patched image train dir')
    parser.add_argument('--mask_train_dir', type=str, default='../ThreeStageBinarization/data/denoise/deep_standard/train/mask_patches/', help='patched mask train dir')
    parser.add_argument('--image_test_dir', type=str, default='../ThreeStageBinarization/data/denoise/DIBCO/test/image/', help='original image test dir')
    parser.add_argument('--mask_test_dir', type=str, default='../ThreeStageBinarization/data/denoise/DIBCO/test/mask/', help='original mask test dir')
