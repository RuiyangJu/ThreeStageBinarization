...
def main():
    image_dir = '../ThreeStageBinarization/image_patches/256X256/'
    rename_dir = '../ThreeStageBinarization/image_patches/(256X256)0_rename/'
    gray_dir = '../ThreeStageBinarization/image_patches/(256X256)1_gray-image/'
    turn_img_to_gray(image_dir,rename_dir,gray_dir)
    split_3_colors = '../ThreeStageBinarization/image_patches/(256X256)2_split_3_colors/'
    image_split_3_colors(image_dir,split_3_colors)
    DWT_4_image_dir = '../ThreeStageBinarization/image_patches/(256X256)3_DWT_4_image/'
    resize_LL_image_dir = '../ThreeStageBinarization/image_patches/(256X256)4_big_LL_image/'
    LL_normalized_dir = '../ThreeStageBinarization/image_patches/(256X256)5_LL_normalized/'
