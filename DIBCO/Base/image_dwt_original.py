...
def main():
    ...
    rename_dir = '../ThreeStageBinarization/select_image/(original_image)0_rename/'
    gray_dir = '../ThreeStageBinarization/select_image/(original_image)1_gray-image/'
    turn_img_to_gray(image_dir,rename_dir,gray_dir)
    split_3_colors = '../ThreeStageBinarization/select_image/(original_image)2_split_3_colors/'
    image_split_3_colors(image_dir,split_3_colors)
    DWT_4_image_dir = '../ThreeStageBinarization/select_image/(original_image)3_DWT_4_image/'
    resize_LL_image_dir = '../ThreeStageBinarization/select_image/(original_image)4_big_LL_image/'
    LL_normalized_dir = '../ThreeStageBinarization/select_image/(original_image)5_LL_normalized/'
