...
def main(argv=None):
    ...
    # image_dirs = ['../ThreeStageBinarization/DIBCO/train/image/', '../ThreeStageBinarization/DIBCO/test/image/']
    # mask_dirs = ['../ThreeStageBinarization/DIBCO/train/mask/', '../ThreeStageBinarization/DIBCO/test/mask/']
    image_dirs = ['../ThreeStageBinarization/image/']
    mask_dirs = ['../ThreeStageBinarization/mask/']
    ...
    # image_save_dirs = ['../ThreeStageBinarization/dibco_resize_6_4/train/image/', '../ThreeStageBinarization/dibco_resize_6_4/test/image/']
    # mask_save_dirs = ['../ThreeStageBinarization/dibco_resize_6_4/train/mask/', '../ThreeStageBinarization/dibco_resize_6_4/test/mask/']

    image_save_dirs = ['../ThreeStageBinarization/image_patches/512X512/']
    mask_save_dirs = ['../ThreeStageBinarization/mask_patches/512X512/']
