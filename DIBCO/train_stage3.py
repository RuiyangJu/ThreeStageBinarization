...
def unetplusplus_train(epochs, gpu, base_model_name, encoder_weights, generator_lr, discriminator_lr, lambda_bce,
    ...
    # make directory
    weight_path = './UnetPlusPlus/stage3_dibco_' + base_model_name + '_' + str(int(lambda_bce)) + '_' + str(generator_lr)
    ...
    # stage3 patch unet++
    patch_model = smp.UnetPlusPlus(base_model_name, encoder_weights=encoder_weights, in_channels=3)
