...
parser.add_argument('--image_train_dir', type=str, default='../ThreeStageBinarization/data/denoise/DIBCO/train/image/', help='original image train dir')
parser.add_argument('--mask_train_dir', type=str, default='../ThreeStageBinarization/denoise/DIBCO/train/mask/', help='original mask train dir')
parser.add_argument('--image_test_dir', type=str, default='../ThreeStageBinarization/denoise/DIBCO/test/image/', help='original image test dir')
parser.add_argument('--mask_test_dir', type=str, default='../ThreeStageBinarization/denoise/DIBCO/test/mask/', help='original mask test dir')
...
parser.add_argument('--original_dir', type=str, default='../ThreeStageBinarization/data/denoise/Label_data', help='original image dir')
...
# make directory
image_save_path = './UnetPlusPlus/predicted_image_for_stage3_dibco_UnetPlusPlus_e_10_bs_16'
